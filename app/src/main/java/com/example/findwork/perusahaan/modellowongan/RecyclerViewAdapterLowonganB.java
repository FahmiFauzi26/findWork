...
public class RecyclerViewAdapterLowonganB extends RecyclerView.Adapter<RecyclerViewAdapterLowonganB.ViewHolder> {private ArrayList<String> posisiLowongan = new ArrayList<>();
    ...
    public RecyclerViewAdapterLowonganB(ArrayList<String> posisiLowongan, ArrayList<String> namaPerusahaan, ArrayList<String> alamatLowongan, ArrayList<String> minimalPendidikan, ArrayList<String> gaji, ArrayList<String> tenggatLowongan, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_lowongan_kerja_bookmarked, parent, false);
        ViewHolder holder = new ViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerViewAdapterLowonganB.ViewHolder holder, int position) {
...
//                Toast.makeText(context, posisiLowongan.get(holder.getAdapterPosition()), Toast.LENGTH_SHORT).show();
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        LinearLayout linearLayoutItemLowonganKerjaBookmarked;
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            linearLayoutItemLowonganKerjaBookmarked = itemView.findViewById(R.id.linearLayoutItemLowonganKerjaBookmarked);
