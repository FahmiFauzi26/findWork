...
public class RecyclerViewAdapterLowonganS extends RecyclerView.Adapter<RecyclerViewAdapterLowonganS.ViewHolder> {private ArrayList<String> posisiLowongan = new ArrayList<>();
    ...
    public RecyclerViewAdapterLowonganS(ArrayList<String> posisiLowongan, ArrayList<String> namaPerusahaan, ArrayList<String> alamatLowongan, ArrayList<String> minimalPendidikan, ArrayList<String> gaji, ArrayList<String> tenggatLowongan, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_lowongan_kerjas, parent, false);
        ViewHolder holder = new ViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerViewAdapterLowonganS.ViewHolder holder, int position) {
